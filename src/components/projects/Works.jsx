                    ...
                    <div className="project__card-grid">
                      ...
                      <div className='project__ImgDemo'>
                          ...
                          <div className='project__buttons' >
                              <a href="" className="project__button demo">Demo {" "}<i className="bx bx-right-arrow-alt project__button-icon"></i></a>
                              <a href="" className="project__button viewCode">View Code </a>
                          </div>
                      </div>
